"""
build.py — PyInstaller packaging script for ReachFlow Pro (reachflow-pro)
...
Distribute the entire dist/ReachFlowPro/ folder to customers — do not distribute
...
def print_success() -> None:
    ...
    print(f"    {dist_path}")
    print()
    print("  Zip the entire dist/ReachFlowPro/ folder and upload that")
